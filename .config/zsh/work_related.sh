...
export BB_ENV_PASSTHROUGH_ADDITIONS="DL_DIR SSTATE_DIR BB_NUMBER_THREADS PARALLEL_MAKE YOCTO_EXPERT_MODE"
...
if [[ ${HOST} == "bitbake" ]]; then
    ...
    unset SSTATE_DIR
    unset DL_DIR
    export BB_ENV_EXTRAWHITE="$BB_ENV_EXTRAWHITE DL_DIR SSTATE_DIR BB_NUMBER_THREADS PARALLEL_MAKE"
